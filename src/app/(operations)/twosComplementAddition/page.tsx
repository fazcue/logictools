...
import { twosComplementAdd } from '@/lib/additions'
import Button from '@/components/Button/Button'

export default function TwosComplementAddition() {
	...
	return (
		<>
			<Column width="200px">
				<Title value="Two's Complement Addition" />
				<HorizontalDivider />
			...
			<Column>
				...
				/>
				<p>=</p>
				<Output value={twosComplementAdd(num1, num2, bits)} />
			</Column>
			<Divider />
